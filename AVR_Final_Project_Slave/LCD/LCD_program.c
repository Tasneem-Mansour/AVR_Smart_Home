...
//	switch(u8key[*index])
//	{
//	case '1': LCD_voidWriteCharctr_4bitMode(u8key[*index]); break;
//	case '2': LCD_voidWriteCharctr_4bitMode(u8key[*index]); break;
//	case '3': LCD_voidWriteCharctr_4bitMode(u8key[*index]); break;
//	case '4': LCD_voidWriteCharctr_4bitMode(u8key[*index]); break;
//	case '5': LCD_voidWriteCharctr_4bitMode(u8key[*index]); break;
//	case '6': LCD_voidWriteCharctr_4bitMode(u8key[*index]); break;
//	case '7': LCD_voidWriteCharctr_4bitMode(u8key[*index]); break;
//	case '8': LCD_voidWriteCharctr_4bitMode(u8key[*index]); break;
//	case '9': LCD_voidWriteCharctr_4bitMode(u8key[*index]); break;
//	case '0': LCD_voidWriteCharctr_4bitMode(u8key[*index]); break;
//
//	case 'A': LCD_voidWriteCharctr_4bitMode(u8key[*index]); break;
//	case 'B': LCD_voidWriteCharctr_4bitMode(u8key[*index]); break;
//	case 'C': LCD_voidWriteCharctr_4bitMode(u8key[*index]); break;
//	case 'D': LCD_voidWriteCharctr_4bitMode(u8key[*index]); break;
//
