...
#define DIO_PIN_NUM_B4_DIR      DIO_INPUT
#define DIO_PIN_NUM_B5_DIR      DIO_INPUT
#define DIO_PIN_NUM_B6_DIR      DIO_OUTPUT
#define DIO_PIN_NUM_B7_DIR      DIO_INPUT


/* PORT C*/
#define DIO_PIN_NUM_C0_DIR      DIO_INPUT
#define DIO_PIN_NUM_C1_DIR      DIO_INPUT
#define DIO_PIN_NUM_C2_DIR      DIO_INPUT
#define DIO_PIN_NUM_C3_DIR      DIO_INPUT
